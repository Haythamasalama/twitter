<template>
	<article class="d-flex px-4 py-3 border-bottom">
		<!-- img profile -->
		<div class="mx-2 w-25">
			<img class="img-fluid rounded-circle" src="https://pbs.twimg.com/profile_images/1346096148604456960/KKA0ct5i_normal.jpg" />
		</div>
		...
		<div>
			...
			<div class="d-flex justify-content-between">
				<div>
					...
					<svg viewBox="0 0 24 24" fill="currentColor" class="primary" style="width: 20px; margin: 0px 5px">
						<g>
				...
				<div>
					<svg width="20px" viewBox="0 0 24 24" stroke="currentColor">
			...
			<div class="w-100">
				...
				<div class="mx-4 d-flex flex-row justify-content-around">
					<div>
						<svg viewBox="0 0 24 24" fill="currentColor" width="20px" class="secondary">
							<g>
