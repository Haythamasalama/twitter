			...
			<div class="w-100">
				...
				<div class="mx-4 p-2 flex flex-row justify-between">
					<div class="flex justify-items-center">
						<div class="mr-2">
							<svg viewBox="0 0 24 24" fill="currentColor" class="text-info w-7 hover:bg-primary-300 hover:text-primary rounded-full p-1">
								<g>
					...
					<div class="flex justify-items-center">
						<div class="mx-2">
							<svg viewBox="0 0 24 24" fill="currentColor" class="text-info w-7 hover:bg-green-50 hover:text-green-600 rounded-full p-1">
								<g>
					...
					<div class="flex justify-items-center">
						<div class="mx-2">
							<svg viewBox="0 0 24 24" fill="currentColor" class="text-info w-7 hover:bg-red-50 hover:text-red-600 rounded-full p-1">
								<g>
