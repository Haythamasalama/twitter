<template>
  <div class="container d-flex flex justify-content-around">
    <!-- header -->
    <header class="mx-5 py-2" style="width: 400px">
      <!-- logo -->
      ...
      <nav class="nav flex-column">
        <li class="nav-item my-3">
          <a class="text-primary" href=""
            ><svg fill="currentColor" viewBox="0 0 24 24" class="icon primary">
              <path
            ...
            <span class="fw-bold text-capitalize fs-5">home</span>
          </a>
        </li>
        <li class="nav-item my-2">
          <a class="text-dark" href="">
            ...
            <span class="fw-bold text-capitalize fs-5">explore</span>
          </a>
        </li>
        <li class="nav-item my-2">
          <a class="text-dark" href="">
            ...
            <span class="fw-bold text-capitalize fs-5">notifiction</span>
          </a>
        </li>
        <li class="nav-item my-2">
          <a class="text-dark" href=""
            ...
            <span class="fw-bold text-capitalize fs-5">massages</span>
          </a>
        </li>
        <li class="nav-item my-2">
          <a class="text-dark" href="">
            ...
            <span class="fw-bold text-capitalize fs-5">bookamrks</span>
          </a>
        </li>
        <li class="nav-item my-2">
          <a class="text-dark" href=""
            ...
            <span class="fw-bold text-capitalize fs-5">list</span>
          </a>
        </li>
        <li class="nav-item my-2">
          <a class="text-dark" href="">
            ...
            <span class="fw-bold text-capitalize fs-5">profile</span>
          </a>
        </li>
        <li class="nav-item my-2">
          <a class="text-dark" href="">
            ...
            <span class="fw-bold text-capitalize fs-5">more</span>
          </a>
        </li>
      </nav>

      <!-- tweet button -->
      <button class="btn btn-primary my-4 text-white py-2 fw-bold shadow w-100">
        Tweet
      </button>
    </header>
    ...
    <main class="mx-2 px-4 py-2">
      <section class="border-start border-end">
        ...
        <section class="d-flex justify-content-between border-bottom px-3 py-1">
          <h4 class="fw-bold">Home</h4>
          <svg
            class="primary icon-width"
            fill="currentColor"
            viewBox="0 0 24 24"
            stroke="none"
          >
        ...
        <section class="new-tweet d-flex border-bottom px-3 py-3 mb-5">
          <div class="mx-2">
            <img
          ...
          <div class="flex-column w-100">
            <textarea class="form-control border-0 fs-5 text-muted" rows="0" cols="0">What's happening?</textarea>
            <div
              class="
                d-flex
                flex-row
            ...
            >
              ...
              <button class="btn btn-primary text-white" disabled>Tweet</button>
            </div>
          </div>
        </section>
        ...
        <article class="d-flex px-4">
          <!-- img profile -->
          <div class="mx-2 w-25">
            <img
              class="img-fluid rounded-circle"
              src="https://pbs.twimg.com/profile_images/1346096148604456960/KKA0ct5i_normal.jpg"
            />
          </div>
          ...
          <div>
            ...
            <div class="d-flex justify-content-between">
              <div>
                <span class="fw-bold">CoinMarketCap</span>
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  class="primary"
            ...
            <!-- contant tweet -->
            <div class="w-100">
              <p class="text-break px-2 my-2">
                Two releases today: - 3.1.5 (stable) - bug fixes (specifically
                script setup features) - 3.2.0-beta.1 - tons of features / perf
                improvements which we will dive into in a blog post when it hits
                stable. If you are curious, check out the changelog:
              </p>
              <div class="m-4 mb-1 border rounded border">
                <img
                  class="img-fluid rounded-top"
                  src="https://pbs.twimg.com/card_img/1418017558255620099/fWA9Z5DD?format=jpg&amp;name=small"
                />
                <p class="p-3">
                  The Alabama Securities Commission asked BlockFi to show why it
                  should not be required stop selling unregistered securities in
                  the state.
                </p>
              </div>
    ...
    <section class="px-4 py-2">
      ...
      <section class="search-tweet"><input type="search" /></section>

      <!-- trands tweet -->

      <section class="trands-tweet">
        <h5>Trends for you</h5>
        <a href="#">
          <div>
            <h4>#trands1</h4>
            <span>91,818 Tweets</span>
          </div>
        </a>
        <a href="#">
          <div>
