    ...
    <div class="row">
      ...
      <div class="col">
        <header class="col mx-4 py-2">
          ...
          <!-- tweet button -->
          <button
            class="btn btn-primary my-4 text-white py-2 fw-bold shadow w-100"
          >
            Tweet
          </button>
        </header>
      ...
      <div class="col-6">
        <main class="mx-1 px-4 py-2">
          <section class="border-start border-end">
            ...
            <section
              class="d-flex justify-content-between border-bottom px-3 py-1"
            >
            ...
            <section
              class="new-tweet d-flex border-bottom border-5 px-3 py-3 mb-5"
            >
              <div class="mx-2">
                <img
              ...
              <div class="flex-column w-100">
                <textarea
                  class="form-control border-0 fs-5 text-muted"
                  rows="0"
                  cols="0"
                >
What's happening?</textarea
            ...
            <article class="d-flex px-4 py-3 border-bottom">
              <!-- img profile -->
              <div class="mx-2 w-25">
                <img
                  class="img-fluid rounded-circle"
              ...
              <div>
                ...
                <div class="w-100">
                  <p class="text-break px-2 my-2">
                    Two releases today: - 3.1.5 (stable) - bug fixes
                    (specifically script setup features) - 3.2.0-beta.1 - tons
                    of features / perf improvements which we will dive into in a
                    blog post when it hits stable. If you are curious, check out
                    the changelog:
                  </p>
                  <div class="m-4 mb-1 border rounded border">
                    ...
                    />
                    <p class="p-3">
                      The Alabama Securities Commission asked BlockFi to show
                      why it should not be required stop selling unregistered
      ...
      <div class="col">
        <section class="py-2">
          ...
          <div
            class="bg-light px-4 py-1 rounded mb-2 d-flex align-items-center"
          >
            <svg
              class="icon-width secondary"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
              <g>
            ...
            <div class="border-bottom py-3">
              <a class="text-secondary" href="#">
                <div class="d-flex flex-column">
                  <span class="fw-bold">#trands1</span>
                  <span class="fs-samll text-muted pt-2">91,818 Tweets</span>
                </div>
              </a>
            </div>
            <div class="border-bottom py-3">
